...
HD_PWD='D:/verilog/fpga/fpga.runs/clk108MHZ_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log clk108MHZ.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source clk108MHZ.tcl
