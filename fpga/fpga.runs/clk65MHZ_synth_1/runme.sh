...
HD_PWD='D:/verilog/fpga/fpga.runs/clk65MHZ_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log clk65MHZ.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source clk65MHZ.tcl
