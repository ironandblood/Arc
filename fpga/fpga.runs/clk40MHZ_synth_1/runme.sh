...
HD_PWD='D:/verilog/fpga/fpga.runs/clk40MHZ_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log clk40MHZ.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source clk40MHZ.tcl
