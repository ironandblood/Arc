...
HD_PWD='D:/verilog/pipline/pipline.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log iotop.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source iotop.tcl -notrace
